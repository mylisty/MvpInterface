...
public class SharedPreferencesUtils {
	...
	public static float getFloat(String key) {
		return getSharedPreferences().getFloat(key, 0.00f);
	}
	...
	private static SharedPreferences getSharedPreferences() {
		if(sp==null){
			sp= MyApplication.getIntance().getSharedPreferences(MyApplication.getIntance().getPackageName(),  Context.MODE_MULTI_PROCESS);
		}
		return sp;
	}
